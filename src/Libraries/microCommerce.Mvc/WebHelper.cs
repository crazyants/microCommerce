...
namespace microCommerce.Mvc
{
    public class WebHelper : IWebHelper
    {
        ...
        /// <returns>Current host location</returns>
        ...
        public virtual string GetCurrentLocation(bool? useSsl = null)
        {
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContextAccessor.HttpContext.Items["System.IsPOSTBeingDone"] == null)
                    return false;

                return Convert.ToBoolean(_httpContextAccessor.HttpContext.Items["System.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContextAccessor.HttpContext.Items["System.IsPOSTBeingDone"] = value;
            }
        }
