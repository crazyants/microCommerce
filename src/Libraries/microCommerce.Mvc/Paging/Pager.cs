    ...
    public class Pager: IHtmlContent
    {
        ...
        public virtual string GenerateHtmlString()
        {
            ...
            if (showTotalSummary && (_model.TotalPages > 0))
            {
                ...
                links.Append(string.Format(localizationService.GetResourceValue("Pager.CurrentPage").Result, _model.PageIndex + 1, _model.TotalPages, _model.TotalItems));
                links.Append("</li>");
            }
            ...
            if (showPagerItems && (_model.TotalPages > 1))
            {
                if (showFirst)
                {
                    ...
                    {
                        links.Append(CreatePageLink(1, localizationService.GetResourceValue("Pager.First").Result, "first-page"));
                    }
                }
                if (showPrevious)
                {
                    ...
                    {
                        links.Append(CreatePageLink(_model.PageIndex, localizationService.GetResourceValue("Pager.Previous").Result, "previous-page"));
                    }
                }
                ...
                if (showNext)
                {
                    ...
                    {
                        links.Append(CreatePageLink(_model.PageIndex + 2, localizationService.GetResourceValue("Pager.Next").Result, "next-page"));
                    }
                }
                if (showLast)
                {
                    ...
                    {
                        links.Append(CreatePageLink(_model.TotalPages, localizationService.GetResourceValue("Pager.Last").Result, "last-page"));
                    }
                }
            }
